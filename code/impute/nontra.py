...
if os.path.exists('nontra'):
    shutil.rmtree('nontra')
...
nontra = NonstationaryTransformer(
    ...
    d_ffn=256,  # 128
    n_heads=4,
    d_projector_hidden=[128,256,128],
    n_projector_hidden_layers=3,
    dropout=0.1,
    epochs=1,
    saving_path="nontra",  # 设置保存路径
...
# 填补缺失值
imputation = nontra.impute(dataset)
