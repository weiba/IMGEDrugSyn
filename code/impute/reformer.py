...
if os.path.exists('reformer'):
    shutil.rmtree('reformer')
...
# 训练模型
reformer.fit(dataset)

# 填补缺失值
imputation = reformer.impute(dataset)
