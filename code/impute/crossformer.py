...
if os.path.exists('crossformer'):
    shutil.rmtree('crossformer')
...
crossformer = Crossformer(
    ...
    dropout=0.1,
    epochs=1000,
    saving_path="crossformer",  # 设置保存路径
...
# 训练模型
crossformer.fit(dataset)

# 填补缺失值
imputation = crossformer.impute(dataset)
